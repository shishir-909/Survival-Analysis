          ...
          card(
            ...
            card_body(
              div(
                ...
                p(
                  "This calculator can be used to estimate the remaining life of a heat exchanger based on wall thickness readings from a sample of tubes. The document below explains the methodology and provides detailed instructions on how to use this calculator. Feel free to contact me if you have any questions.",
                  style = "font-size: 18px; margin-bottom: 30px; line-height: 1.6;"
                ),
                # Embedded PDF
                tags$iframe(
                  src = "Estimating Remaining Life of Heat Exchangers using Extreme Value Analysis.pdf",
                  width = "100%",
                  height = "600px",
                ...
                p(
                  ...
                  ".",
                  style = "font-size: 16px; margin-top: 20px; color: #666;"
                )
              )
            )
          )
